        ...
        this(
            ...
            largeImage != null || smallImage != null
                ? new ActivityBuilder.Assets(
                      largeImage != null
                          ? new ActivityBuilder.Asset(largeImage, largeText)
                          : null,
                      smallImage != null
                          ? new ActivityBuilder.Asset(smallImage, smallText)
                          : null
                  )
                : null,
            timestampStart != 0
                ? new Timestamps(timestampStart, timestampEnd)
                : null,
            partyId != null
                ? new Party(partyId, partySize, partyMaxSize, partyIsPublic)
                : null,
